...
class ImageTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if imageClass != nil{return IdentifierList[imageClass!]!.count}
        else{return 0}
    }

    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "snackImage", for: indexPath) as! ImageTableViewCell
        cell.imageV.image = IdentifierList[imageClass!]![indexPath.row]
        // Configure the cell...
